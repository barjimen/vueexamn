    ...
    <div>
        <nav class="navbar navbar-expand-sm navbar-dark bg-dark" aria-label="Third navbar example">
            <div class="container-fluid">
                <router-link class="navbar-brand" to="/">RUBIK MASTERS</router-link>
                        ...
                        <li class="nav-item dropdown" v-if="isLogin">
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown-item ">
                                    <router-link to="/perfil" v-if="isLogin">
                                        Perfil </router-link>
                                </li>
                                <li class="dropdown-item ">
                                    <router-link to="/compras" v-if="isLogin">
                                        Compras </router-link>
                                </li>
                                <li class="dropdown-item ">
                                    <router-link to="/pedidos" v-if="isLogin">
                                        Realizar Pedidos </router-link>
                                </li>
                            </ul>
